...
synth_design -top m6502 -part xc7a100tcsg324-1


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef m6502.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file m6502_utilization_synth.rpt -pb m6502_utilization_synth.pb"
