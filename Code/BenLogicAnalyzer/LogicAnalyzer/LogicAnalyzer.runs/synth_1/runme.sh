...
HD_PWD='C:/Hercu-NES/Code/BenLogicAnalyzer/LogicAnalyzer/LogicAnalyzer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LogicAnalyzer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LogicAnalyzer.tcl
