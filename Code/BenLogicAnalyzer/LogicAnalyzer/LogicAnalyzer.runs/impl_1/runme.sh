...
HD_PWD='C:/Hercu-NES/Code/BenLogicAnalyzer/LogicAnalyzer/LogicAnalyzer.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log LogicAnalyzer.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source LogicAnalyzer.tcl -notrace
